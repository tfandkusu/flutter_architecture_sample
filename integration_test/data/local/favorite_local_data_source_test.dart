...
void main() {
  test("FavoriteLocalDataSource", () async {
    ...
    localDataSource.setFavorite('flutter_architecture_sample', true);
    ...
    localDataSource.setFavorite('android_app_template', true);
    ...
    localDataSource.setFavorite('flutter_architecture_sample', false);
    ...
    expect(await localDataSource.getFavoriteRepoNameSet(),
        <String>{'android_app_template'});
    // 存在しないリポジトリの「いいね」を消す
    localDataSource.setFavorite('unknown', false);
    expect(await localDataSource.getFavoriteRepoNameSet(),
        <String>{'android_app_template'});
  });
}
